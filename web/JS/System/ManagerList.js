...
function loadData(nPage) {
    CS('CZCLZ.AdminDB.GetManagerList', function (retVal) {
        store.setData({
            data: retVal.dt,
            pageSize: pageSize,
            total: retVal.ac,
...
function sh(id) {
    ...
    Ext.MessageBox.confirm('提示', '确定审核？', function (obj) {
        if (obj == "yes") {
            CS('CZCLZ.AdminDB.PassManager', function (retVal) {
                if (retVal) {
                             ...
                             },
                              {
...

                               {
                               ...
                               },
                                 {
                                     ...
                                     renderer: function (value, cellmeta, record, rowIndex, columnIndex, store) {
                                         var str = "";
                                         str = "<a href='#' onclick='sh(\"" + record.data.ID + "\")'>审核通过</a>";
                                         return str;
                                     }
                                 }
