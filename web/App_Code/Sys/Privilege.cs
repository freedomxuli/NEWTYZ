...
public class PrivilegeDescription
{
    ...
    public PrivilegeDescription(string szModuleName, string szPrivilegeName, int orderno)
    {
        ...
        cmd.Parameters.Add("@PrivilegeCode", MySqlDbType.VarChar).Value = (Guid)this;
        cmd.Parameters.Add("@PrivilegeName", MySqlDbType.VarChar, 100).Value = PrivilegeName;
        cmd.Parameters.Add("@ModuleName", MySqlDbType.VarChar, 100).Value = ModuleName;
    ...
    public static DataTable PrivilegeType()
    {
        ...
        using (dbcon)
        {
            string sql = "select distinct(substring(ModuleName,1,locate('-',ModuleName))) as ModuleName from tb_b_YH_QX";
    ...
    public static DataTable GetPrivilegeByModuleName(string strModuleName)
    {
        ...
        using (dbcon)
        {
            string sql = "select PrivilegeCode,PrivilegeName, substring(ModuleName,locate('-',ModuleName)+1,(len(ModuleName)-locate('-',ModuleName))) as  ModuleName "
